...
def main():
    lmdb_name = "/media/dlw/work/featurefusion/googlenet/feature/google_pool5_test8"
    print ("%s" % lmdb_name)
    batch_num = int(1);
    batch_size = int(6080);
    ...
    for i in range(batch_num):
        ft = np.zeros((batch_size, int(1024)))
        ...
        sio.savemat("/media/dlw/work/featurefusion/googlenet/feature/google_pool5_test8%s" % str(i) ,{'feats':ft})
